...
const CollectionCategory = ({ filter, setFilter }) => {
  ...
  const subcategories = selectedCategorySlug ? selectedCategory?.subcategories || [] : categoryData;
            ...
            <li key={i}>
              <div className='form-check category-list-box'>
                <Input
                  ...
                  onChange={(e) => redirectToCollection(e, elem?.slug, 'category')}
                />
            ...
            <li key={i}>
              <div className='form-check category-list-box'>
                <Input
                  ...
                  onChange={(e) => redirectToCollection(e, elem?.slug, 'subcategory')}
                />
                <Label className='form-check-label' htmlFor={elem?.name}>
                  <span className='name'>{elem?.name}</span>
                  <span className='number'>({elem?.products_count || elem?.product_count})</span>
                </Label>
              </div>
            </li>
          ))}
